...
musical constructs such as beams, slurs and glissandi which can cross different
levels of hierarchy in the score tree. Indicators model objects attached to a
single component. These include articulations, time signatures, tempi, textural
indications and dynamics.\footnote{Indicators can have \emph{scope} making them
