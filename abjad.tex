...
iterating over the components in a score in different ways. For example, only
the \texttt{Note} objects can be selected from the lower staff:
...
\noindent An entire score can be iterated in attack-point order:
