...
Abjad is not a stand-alone application for composers. Nor is Abjad a programming language. Abjad is instead an extension to the Python
...
In designing Abjad as an extension to a widely used language, we hope to make relevant
...
in the Python available to composers working with notation in a formalized way. 
...
fact that the language is part of a global programming mainstream with tools and best practices that can be borrowed directly into the work of music composition.
