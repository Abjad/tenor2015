...
\section{Development practices} \label{sec:development}
...
integration testing is handled by Travis CI to ensure that all tests pass after every commit from every developer.
