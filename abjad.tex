...
higher-level musical objects, each of which generates many components.

Abjad provides a variety of factory functions and factory classes for
...
processes to enable the parametric exploration of related compositional possibilities.
\end{comment}
