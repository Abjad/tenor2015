...
In designing Abjad as an extension to a very widely used language, we hope to make relevant
the hundreds of available print and Web resources that detail
Python and its features. We also hope to make the global community of developers working
in Python available to composers. 
But we note that even though we find Python an excellent programming
