...
Abjad implements many different factories, any of which can be customized or sub-classed, and composers can extend the system as they work to implement their own models of composition. Abjad also provides a variety of factory functions and factory classes for
