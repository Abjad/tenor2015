...
\def\papertitle{Design Priorities in Abjad, A Python API for Formalized Score Control}
...
\input{section_0_introduction.tex}
\input{section_1_background.tex}
\input{section_2_notational_isomorphism.tex}
\input{section_3_relationship_modeling.tex}
\input{section_4_score_addressability.tex}
\input{section_5_extensibility.tex}
\input{section_6_embeddability.tex}
\input{section_7_open_source.tex}
