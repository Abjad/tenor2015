...
Abjad is not a programming language. Abjad instead extends the Python
...
both the hundreds of available print and Web resources that detail
Python and its features as well as the global community of developers working
in the language. We hope both benefits will ease composers' transition to
...
\section{An example usage session} \label{sec:illustration}
