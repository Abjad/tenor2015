...
hierarchically into a tree, with containers used to nest other components
together inside them. Spanners model musical constructs such as beams, slurs
...
articulations, time signatures, tempi, textural indications and
dynamics.\footnote{Indicators can have \emph{scope} making them
