...
Abjad invites composers generalize and encapsulate processes to enable the parametric exploration of material by implementing factories. In this way, composers can extend the system as they work to implement their own models of composition. Abjad also provides a variety of example factory functions and factory classes that exemplify top-down construction. These range from simple note-generating functions, like \texttt{make\_notes()}, which
