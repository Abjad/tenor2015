...
>>> show(score)
\end{lstlisting}
\includegraphics{assets/lilypond-f7e01534b99f9f1501e5d707f5038fbe.pdf}
%%% ABJADBOOK END %%%

\noindent Composers can attach spanners (such as ties and slurs) to score components via
...
\noindent Composers can also attach indicators (such as articulations and clefs) to
...
>>> show(score)
\end{lstlisting}
\includegraphics{assets/lilypond-9c0ed155a455f116485bdbfe18da703f.pdf}
%%% ABJADBOOK END %%%
...
>>> show(upper_staff)
\end{lstlisting}
\includegraphics{assets/lilypond-5d0cd6314dd2737adf4b477c7a2fa2fc.pdf}
%%% ABJADBOOK END %%%
...
>>> show(score)
\end{lstlisting}
\includegraphics{assets/lilypond-b2cb98e1e73d5c07314a7f0267e0d26b.pdf}
%%% ABJADBOOK END %%%
...
>>> show(score)
\end{lstlisting}
\includegraphics{assets/lilypond-2c8af83002776b93135ce1f89a65b066.pdf}
%%% ABJADBOOK END %%%
...
>>> show(score)
\end{lstlisting}
\includegraphics{assets/lilypond-10d5b9d7051dfce5eacfa56f79ea923a.pdf}
%%% ABJADBOOK END %%%
