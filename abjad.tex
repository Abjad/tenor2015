...
>>> show(score)
\end{lstlisting}
\includegraphics{assets/lilypond-20f1d7c6901d7908e6e890db49c028f0.pdf}
%%% ABJADBOOK END %%%
...
>>> show(score)
\end{lstlisting}
\includegraphics{assets/lilypond-1f45812a820d00be678059350542a032.pdf}
%%% ABJADBOOK END %%%
...
>>> show(staff)
\end{lstlisting}
\includegraphics{assets/lilypond-8d7f5c809119d4fe1011ddb641d933b5.pdf}
%%% ABJADBOOK END %%%
...
>>> show(rhythm_maker, divisions=divisions)
\end{lstlisting}
\includegraphics{assets/lilypond-4ae6f4fae5382e2cccef70ab8113deac.pdf}
%%% ABJADBOOK END %%%
...
>>> show(rhythm_maker, divisions=divisions)
\end{lstlisting}
\includegraphics{assets/lilypond-ac2b3cf0b6a8e21879e6f5b59c0024f2.pdf}
%%% ABJADBOOK END %%%
...
>>> show(quartet_score)
\end{lstlisting}
\includegraphics{assets/lilypond-bc8501b1d04f6de02b57061378cc26af.pdf}
%%% ABJADBOOK END %%%
...
>>> show(upper_staff)
\end{lstlisting}
\includegraphics{assets/lilypond-03f40de384775683b89e8a37c094b7d7.pdf}
%%% ABJADBOOK END %%%
...
>>> show(lower_staff)
\end{lstlisting}
\includegraphics{assets/lilypond-40c23e4317fc6e9dfbd7031e78a2fe2c.pdf}
%%% ABJADBOOK END %%%
...
>>> show(score)
\end{lstlisting}
\includegraphics{assets/lilypond-099666789f942090641921eb735887dd.pdf}
%%% ABJADBOOK END %%%
...
>>> show(score)
\end{lstlisting}
\includegraphics{assets/lilypond-a997e5550e54433f21d32e04c8b2bdd3.pdf}
%%% ABJADBOOK END %%%
...
>>> show(score)
\end{lstlisting}
\includegraphics{assets/lilypond-f9414f94bf4a83ca429243f2165214b3.pdf}
%%% ABJADBOOK END %%%
...
>>> show(rhythm_maker, divisions=divisions)
\end{lstlisting}
\includegraphics{assets/lilypond-3061dd8148e3f75573756fea58330155.pdf}
%%% ABJADBOOK END %%%
...
>>> show(new_rhythm_maker, divisions=divisions)
\end{lstlisting}
\includegraphics{assets/lilypond-9c06be1c324b8c1914fa61b455792e12.pdf}
%%% ABJADBOOK END %%%
...
>>> show(new_new_rhythm_maker, divisions=divisions)
\end{lstlisting}
\includegraphics{assets/lilypond-6e73e89c1e3b15970212d5ef404853ba.pdf}
%%% ABJADBOOK END %%%
