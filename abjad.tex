...
The design and development priorities for Abjad we have outlined here derive directly from the fact that the developers of Abjad are all composers. Abjad is not implemented for the type of music information and retrieval functions that constitute an important part of many musicology-oriented music software systems. Nor is Abjad designed for use in realtime contexts of performance or sound synthesis. We have designed Abjad as a composers' toolkit for the formalized control of music notation and for the infinite array of musical relationships notation can be used to explore, create and represent.
