...
explicit names, they can also be selected by those names, regardless of their
depth in the score hierarchy. Here we select the lower staff by name:
...
\noindent The upper staff can be selected by indexing the first child of the
first child of the score, i.e. the first staff in the staff group which is the
first child of the score itself.
...
\noindent A score container's leaves --- the notes, chords and rests at the bottom of the
