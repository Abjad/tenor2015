...
ways: by number, name or temporal succession. A single operation can be mapped onto the entirety of a selection. Ad hoc intermediate structures can be created as they become
