...
Abjad invites composers to implement factories as a way of generalizing and encapsulating parts of one's own compositional process. In this way, they can extend the system as they work to implement their own models of composition. Abjad also provides a variety of example factory functions and factory classes that exemplify top-down construction. These range from simple note-generating functions, like \texttt{make\_notes()}, which
