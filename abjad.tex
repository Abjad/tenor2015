...
\section{Extension, not reinvention}
...
\section{Pervasive illustration}

We believe it is important for
composers to be able to illustrate the objects they work with as they compose.
Abjad reflects this priority in the \emph{illustration protocol} established to provide composers a uniform way of visualizing all the elements of of common practice notation as well as conventional and composer-defined music-theoretic objects like rhythmic constructors or the Xenakis sieves.\footnote{Python describes common
...
Composers call the top-level \texttt{show()} function to visualize
