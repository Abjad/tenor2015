...
Ad hoc intermediate structures can be created as they become
compositionally relevant.
A single operation, such as attaching an articulation, can then be mapped onto the entirety of a selection.
