...
In addition to bottom-up construction, Abjad allows composers to work with
higher-level musical objects, each of which generates many components: Abjad implements many different factories, any of which can be customized or sub-classed, and composers can extend the system as they work to implement their own models of composition.

Abjad also provides a variety of factory functions and factory classes for
