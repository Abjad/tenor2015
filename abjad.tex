...
\section{Motivation}
Abjad provides low-level sufficiently detailed model of common practice notation while enabling the user to model compositional processes and relationships.
