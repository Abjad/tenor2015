...
We consider the act of composition then to revolve around the iterative
aggregation of notational primitives into arbitrarily complex score objects.
...
\begin{lstlisting}>>> selection = scoretools.make_notes("c'", [(5, 16)])
...
\begin{lstlisting}>>> selection = scoretools.make_notes("c'", [(1, 12)] * 3)
>>> tuplet = selection[0]
>>> show(tuplet)
\end{lstlisting}
...
\begin{lstlisting}>>> tuplet.toggle_prolation()
>>> show(tuplet)
\end{lstlisting}
